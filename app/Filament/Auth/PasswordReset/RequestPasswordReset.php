...
class RequestPasswordReset extends SimplePage
{
     ...
     * @var view-string
     */
    protected static string $view = 'auth.password-reset.request-password-reset';
    ...
    public function request(): void
    {
        ...
        $dataType = filter_var($data['login'], FILTER_VALIDATE_EMAIL) ? 'email' : 'username';
    ...
    protected function getForms(): array
    {
        return [
            'form' => $this->form(
                $this->makeForm()
                    ->schema([
                        $this->getUserOrEmailFormComponent(),
                    ])
                    ->statePath('data'),
            ),
        ];
    ...
    protected function getUserOrEmailFormComponent(): Component
    {
    ...
    public function loginAction(): Action
    {
        return Action::make('login')
            ...
            ->icon(match (__('filament-panels::layout.direction')) {
                'rtl' =>
                    FilamentIcon::resolve('panels::pages.password-reset.request-password-reset.actions.login.rtl') ?? 'heroicon-m-arrow-right',
                default =>
                    FilamentIcon::resolve('panels::pages.password-reset.request-password-reset.actions.login') ?? 'heroicon-m-arrow-left',
            })
